...
static const char qt_meta_stringdata_PostHttp[] = {
    "PostHttp\0\0info\0complete(QString)\0"
    "serverResponseType\0body\0post(QString)\0"
    "onGetReply()\0"
};
...
void PostHttp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { serverResponseType _r = _t->post((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< serverResponseType*>(_a[0]) = _r; }  break;
