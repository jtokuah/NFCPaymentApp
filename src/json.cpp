...
namespace QtJson {
    ...
    QVariant parse(const QString &json, bool &success) {
        ...
        if (!json.isNull() || !json.isEmpty()) {
        	qDebug() << "XXXX QtJson: will parse non-empty QVariant";
            QString data = json;
            ...
            return QVariant();
            qDebug() << "XXXX QtJson: The JSON data is null or empty";
        }
    }
    ...
    static QVariant parseValue(const QString &json, int &index, bool &success) {
        ...
        switch(lookAhead(json, index)) {
            ...
            case JsonTokenNone:
                break;
            default:
            	qDebug() << "XXXX QtJson: could not identify Json Token at index %1" << index;
            	break;
        }
